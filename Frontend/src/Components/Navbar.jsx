...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full overflow-hidden transition-all duration-500 ease-in-out ${menuOpen ? "max-h-[500px] border-b border-white/10 opacity-100" : "max-h-0 opacity-0"
